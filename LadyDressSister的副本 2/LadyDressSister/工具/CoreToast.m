...
+(void)showMsgType:(CoreToastMsgType)msgType msg:(NSString *)msg subMsg:(NSString *)subMsg timeInterval:(NSTimeInterval)timeInterval trigger:(UIView *)trigger apperanceBlock:(void(^)(void))apperanceBlock completionBlock:(void(^)())completionBlock{
...
+(NSMutableDictionary *)settingDict{
    ...
    NSDictionary *settingDict=@{
       ...
       kCRToastBackgroundColorKey:HRGB(0xfb83ac),                                              //背景颜色
       ...
       kCRToastAnimationInDirectionKey:@(CRToastAnimationDirectionTop),                              //进入动画的方向：左
       
       kCRToastAnimationOutDirectionKey:@(CRToastAnimationDirectionTop),                             //进入动画的方向：右
       ...
       kCRToastSubtitleFontKey:[UIFont systemFontOfSize:13.0f],                                        //子标题字体大小
