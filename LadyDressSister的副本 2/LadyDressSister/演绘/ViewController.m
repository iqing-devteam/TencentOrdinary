...
- (void)viewDidLoad {
    [super viewDidLoad];
//    [AXEGameSDK defaultSDK].delegate = self;
//    [AXEGameSDK defaultSDK].debug = YES;
//    AXEUserData = [NSMutableDictionary new];
...
-(void)getData{
    ...
    [[QWNetWorkService shareInstance]requestWithURL:url params:params httpMethod:@"GET" hasCertificate:NO sucess:^(AFHTTPRequestOperation *operation, id responseObject) {
